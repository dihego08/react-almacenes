        ...
        return (
            <View style={styles.viewStyle}>
                ...
                <View style={styles.encabezado}>
                    <View>
                        <Text style={styles.textotitulo1}>Condutores</Text>
                        <Text style={styles.textosubtitulo}>¡Conducir es un arte!</Text>
                    </View>
                    <View>
                ...
                <View style={styles.container}>
                    ...
                    <Text style={styles.textotitulo2}> NUEVO CONDUCTOR </Text>
                        ...
                        <View style={styles.action}>
                            ...
                            <TextInput
                                placeholder="Apellidos de Conductor"
                                placeholderTextColor="#B2BABB"
                                style={styles.textInput}
                                onChangeText={email => this.setState({ email })}
                            />
                        ...
                        <View style={styles.action}>
                            <View style={styles.iconocirculobusca}>
                                <MaterialIcons name='fingerprint' style={styles.iconosbusca} />
                            </View>
                            <TextInput
                                placeholder="DNI"
                                placeholderTextColor="#B2BABB"
                        ...
                        <View style={styles.action}>
                            <View style={styles.iconocirculobusca}>
                                <MaterialIcons name='house' style={styles.iconosbusca} />
                            </View>
                            <TextInput
                        ...
                        <View style={styles.action}>
                            <View style={styles.iconocirculobusca}>
                                <MaterialIcons name='phone-android' style={styles.iconosbusca} />
                            </View>
                            <TextInput
                                placeholder="Celular"
                                placeholderTextColor="#B2BABB"
                        ...
                        <View style={styles.action}>
                            <View style={styles.iconocirculobusca}>
                                <MaterialIcons name='contact-page' style={styles.iconosbusca} />
                            </View>
                            <TextInput
                        ...
                        <View style={styles.loginButtonSection}>
                                ...
                                >
                                    <View style={styles.contenidoboton}>
                                        ...
                                        <Text style={styles.textbtn}>Registrar Conductor</Text>
                                    </View>
                                </Pressable>
                            </View>
