        ...
        return (
            <View style={styles.viewStyle}>
                ...
                <View style={styles.container}>
                    ...
                    <Text style={styles.textotitulo2}> NUEVO PRODUCTO </Text>
                        ...
                        <View style={styles.action}>
                            <View style={styles.iconocirculobusca}>
                                <MaterialIcons name='wine-bar' style={styles.iconosbusca} />
                            </View>
                            <TextInput
                        ...
                        <View style={styles.action}>
                            <View style={styles.iconocirculobusca}>
                                <MaterialIcons name='loyalty' style={styles.iconosbusca} />
                            </View>
                            <TextInput
                        ...
                        <View style={styles.loginButtonSection}>
                                ...
                                >
                                    <View style={styles.contenidoboton}>
                                        ...
                                        <Text style={styles.textbtn}>Registrar Producto</Text>
                                    </View>
                                </Pressable>
                            </View>
