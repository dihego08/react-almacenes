        ...
        return (
            <View style={styles.viewStyle}>
                ...
                <View style={styles.encabezado}>
                    <View>
                        <Text style={styles.textotitulo1}>Usuarios</Text>
                        <Text style={styles.textosubtitulo}>¡Ingresemos a la labor!</Text>
                    </View>
                    <View>
                ...
                <View style={styles.container}>
                    ...
                    <Text style={styles.textotitulo2}> NUEVO USUARIO </Text>
                        ...
                        <View style={styles.action}>
                            <View style={styles.iconocirculobusca}>
                                <MaterialIcons name='vpn-key' style={styles.iconosbusca} />
                            </View>
                            <TextInput
                        ...
                        <View style={styles.loginButtonSection}>
                                ...
                                >
                                    <View style={styles.contenidoboton}>
                                        ...
                                        <Text style={styles.textbtn}>Registrar Usuario</Text>
                                    </View>
                                </Pressable>
                            </View>
