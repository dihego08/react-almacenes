            ...
            <View style={styles.viewStyle}>
                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.contenedoraction}>
                        <Text style={styles.textotitulo2}> NUEVO PEDIDO </Text>
                        ...
                        <View style={styles.action}>
                            <View style={styles.iconocirculobusca}>
                                <MaterialIcons name='content-paste' style={styles.iconosbusca} />
                            </View>
                            <TextInput
                                placeholder="Pedido"
                                placeholderTextColor="#B2BABB"
                        ...
                        <View style={styles.loginButtonSection}>
                            ...
                            >
                                <View style={styles.contenidoboton}>
                                    ...
                                    <Text style={styles.textbtn}>Registrar Pedido</Text>
                                </View>
                            </Pressable>
                        </View>
